...
class QuoridorX(Quoridor):
    def __init__(self, joueurs, murs=None, tour=1):
        ...
        self.screen.onkey(lambda: self.changer_orientation('H'), "h")
        self.screen.onkey(lambda: self.changer_orientation('V'), "v")
    ...
    def clic_plateau(self, x, y):
        ...
        joueur = self.joueurs[0]['nom']  # joueur humain
